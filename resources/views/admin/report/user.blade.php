...
<head>
    ...
    <title>User Registrations Report - My Batik Admin</title>
            ...
            <div class="flex flex-col md:flex-row gap-8">
                <aside class="w-full md:w-1/4">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="{{ route('admin.reports.users') }}" class="block px-4 py-2 rounded-md bg-blue-100 text-blue-700 font-bold">User Registrations</a></li>
